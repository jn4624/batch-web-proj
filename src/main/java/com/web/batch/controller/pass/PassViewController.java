package com.web.batch.controller.pass;

import com.web.batch.service.pass.Pass;
import com.web.batch.service.pass.PassService;
import com.web.batch.service.user.User;
import com.web.batch.service.user.UserService;
...
/**
 * 사용자가 보는 이용권 조회 페이지를 반환하기 위한 컨트롤러
 */
@Controller
